(function(){
    ...
    */
    ...
    var sul = ['São paulo','Minas Gerais','Rio de Janeiro','Espirito Santo'];
    var sudeste = ['Paraná','Santa Catarina','Rio grande do Sul'];
    ...
    */
    var nordeste = ['Piauí','Bahia','Maranhão']
    ...
    */
    ...
    chamada `newSudeste`.
    */
    var newSudeste = brasil.splice(6);
