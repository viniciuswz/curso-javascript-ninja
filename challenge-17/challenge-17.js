(function(){
    ...
    */
    ...
    console.log(text.replace(/(Manuel Marques de Sousa)/ , 'Vinícius Araújo da Silva'));
    ...
    */
    ...
    console.log(text.replace(/[aA]/g, '0'));
    ...
    */
    ...
    console.log(text.replace(/(O Centauro de Luvas)/, function(txt){
    ...
    */
    ...
    console.log(getMonthNumber('fevereiro'));
    ...
    */
    console.log( '\nReplace de datas:' );
    function replaceDate(txt){
        return txt.replace(regexDate, function(allText,n1,month,year){
            return n1 + '/' + getMonthNumber(month) + '/' + year
        })
    }
