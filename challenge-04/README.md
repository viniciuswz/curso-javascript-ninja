...
carro.addPessoas = function(a){
    ...
    if(carro.quantidadePessoas + a > carro.assentos){
        var complemento = carro.assentos - carro.quantidadePessoas == 1 ? complemento =" pessoa" : complemento = " pessoas";
        var qtd = carro.assentos - carro.quantidadePessoas;
        return "Só cabem mais "+ qtd  + complemento;
    }
