(function(){
    ...
    */
    ...
    console.log(showOperationMessage(operationSignal,number1,number2), sum == false ? showErrorMessage(operationSignal) : sum(number1,number2));
    ...
    */
    ...
    console.log(showOperationMessage(operationSignal,number1,number2), subtraction == false ? showErrorMessage(operationSignal) : subtraction(number1,number2));
    
    var operationSignal = '/';
    var division = calculator(operationSignal);
    
    console.log(showOperationMessage(operationSignal,number1,number2), division == false ? showErrorMessage(operationSignal) : division(number1,number2));
    
    var operationSignal = '%';
    var mod = calculator(operationSignal);
    
    console.log(showOperationMessage(operationSignal,number1,number2), mod == false ? showErrorMessage(operationSignal) : mod(number1,number2));
    
    var operationSignal = '*';
    var multiplication = calculator(operationSignal);
    
    console.log(showOperationMessage(operationSignal,number1,number2), multiplication == false ? showErrorMessage(operationSignal) : multiplication(number1,number2));
